  ...
  return (
    <html lang="en">
      ...
      <body className="min-h-screen bg-white antialiased overflow-x-hidden">
        ...
        <footer className="mx-auto max-w-[640px] px-4 py-8 text-center text-xs sm:text-sm text-anon-gray">TipJar · Lagos · <span className="font-mono">Paystack secured</span> · <a href="/pricing" className="underline">Pricing</a> · <a href="/share-guide" className="underline">Share guide</a> · <a href="/terms" className="underline">Terms</a> · <a href="/privacy" className="underline">Privacy</a> · <a href="/refunds" className="underline">Refunds</a></footer>
      </body>
    </html>
  );
}
