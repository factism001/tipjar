  ...
  return (
    <div className="pt-4 w-full min-w-0">
      <div className="overflow-hidden rounded-xl bg-charcoal">
        ...
        <img src={`https://picsum.photos/seed/video-${params.id}/640/800`} alt="video thumb" width={640} height={800} className="aspect-[9/14] sm:aspect-[9/12] max-h-[60vh] sm:max-h-[480px] w-full object-cover object-center" sizes="(max-width: 640px) 100vw, 640px" />
