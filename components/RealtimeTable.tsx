  ...
  if (tips.length === 0) {
    return (
      <div className="rounded-xl border border-dashed border-[#E5E7EB] p-8 text-center">
        <p className="text-sm text-anon-gray">No tips yet — share your @handle! ✨</p>
  ...
  return (
    <div className="rounded-xl border border-[#E5E7EB] bg-white shadow-sm overflow-hidden">
      <div className="flex items-center justify-between px-4 py-3 border-b border-[#E5E7EB]">
        <h3 className="text-sm font-bold text-charcoal">Tips feed</h3>
      ...
      <ul className="divide-y divide-[#F3F4F6] max-h-[520px] overflow-auto">
        {shown.map((t) => (
          <li key={t.id} className="flex items-center gap-3 px-4 py-3 hover:bg-[#F9FAFB]">
            ...
            <div className="min-w-0 flex-1">
              <p className="text-sm font-semibold text-charcoal truncate">
                ₦{t.amount.toLocaleString("en-NG")} · {t.is_anonymous ? <span className="text-anon-gray">anon</span> : t.tipper} · <span className="font-normal text-anon-gray">{timeAgo(t.created_at)}</span>
              </p>
            ...
            <div className="flex items-center gap-2 shrink-0">
              ...
              <a
                ...
                className="inline-flex min-h-[44px] items-center rounded-full bg-brand-blue px-4 text-xs font-semibold text-white hover:bg-[#0046CC] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-blue/30"
              >
                Thank
              </a>
            </div>
